...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-jx-panel border border-jx-border p-1 text-jx-muted",
      className
    )}
    {...props}
  />
